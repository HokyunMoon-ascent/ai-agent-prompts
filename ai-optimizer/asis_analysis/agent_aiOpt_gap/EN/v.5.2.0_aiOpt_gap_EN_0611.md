<!-- v.5.2.0_aiOpt_gap_EN_0611.md (updated 2026-06-11) -->
...
* Owned content URLs and body text: {{page_content_A}}  
...
9. **Owned Brand identification**: identify the brand under analysis internally from the analysis keyword and the owned content (URL and body text) cues. Do not declare "The Owned Brand is OOO" in the body.  
...
13. **Using consumer language**: use the consumer language that appears in the AI responses and the CEP prompt as cues for question expansion. Do not simply repeat the list of expressions; use them as grounds for understanding the consumer criteria the AI misses or competitor brands occupy.  
...
26. Extract from the consumer language in the AI responses and the CEP prompt the question expansions and criteria that can become owned/earned candidates.  
...
31. Do not read the numbers verbatim; interpret their meaning in natural language.
...
Write only one line per topic group. Write the items to hand off to the owned media agent around "owned information, product data, usage situation descriptions, comparison criteria, consumer language". Write the items to hand off to the trust-evidence media agent around "reviews, communities, experts, media, retail platforms, externally cited domains". Do not give execution instructions; close with "a candidate to verify", "a candidate to analyze", "a slot to hand off".
...
37. Did you use the consumer language within the AI responses as cues for question expansion?  
