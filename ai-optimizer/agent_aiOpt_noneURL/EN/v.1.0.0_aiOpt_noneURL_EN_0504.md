...
5. **Brand citation pattern analysis**: organize the brand/product proper nouns that appear in AI responses along with their citation grounds (RTB, attributes, numbers, reviews).
6. **Semantic-area diagnosis**: for each area, assign intent alignment / response evidence / entity-topic decomposition / decision implication.
7. **Downstream-use & handoff memo**: write additional-verification areas, opportunity-area memo, and downstream-agent handoff labels.
...
- **Brand X**: appearances — AI Response 1, AI Response 2 / citation grounds — :k[attribute/number expression], :k[review expression]
- **Brand Y**: appearances — AI Response 3 / citation grounds — :k[attribute/number expression]
...
2. For each area, fill out all five items below.
