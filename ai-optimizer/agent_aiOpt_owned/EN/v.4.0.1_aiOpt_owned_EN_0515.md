<!-- v.4.0.1_aiOpt_owned_EN_0515.md (updated 2026-05-15) -->
...
Close with one sentence "**Overall** — ..." at the end. Keep the entire consolidated commentary at **roughly 400 characters** (±50 characters), do not place a separate commentary between Tables ➊ and ➋, and instead place only one consolidated commentary immediately after Table ➋. Compress the main bullet per topic group to a single bullet per group, while keeping the one-line rationale for the New / Existing decision.
...
14. Consolidated commentary length: no separate commentary is inserted between Tables ➊ and ➋, and the consolidated commentary immediately after Table ➋ closes at roughly 400 characters (±50 characters)?
