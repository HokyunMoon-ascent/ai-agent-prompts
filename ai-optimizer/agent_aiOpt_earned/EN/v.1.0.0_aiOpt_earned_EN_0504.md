<!-- v.1.0.0_aiOpt_earned_EN_0504.md (updated 2026-06-01) -->
...
- Map the **Earned-labeled recommendations** from Gap Analysis Results to the media categories at the RTB level.
...
- For each gap, fill in all 6 fields:
...
- **Content Format**: Form spontaneous user review topics or transparent Q&A participation by an official account (directional guide only, 1–2 sentences)
