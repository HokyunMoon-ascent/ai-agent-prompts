...
- **Re-decision Rationale**: one sentence (based on the Owned Page's center of gravity + CEP alignment)
...
5. After drafting the body, self-declare in one sentence in the "External Fact Check" item that no new external facts (new product names, numbers, certifications) are included.
