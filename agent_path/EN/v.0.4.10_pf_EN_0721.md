<!-- v.0.4.10_pf_EN_0721.md (updated 2026-07-21) -->
...
2. **Accordion & Markdown Optimization Rules (Accordion & Markdown Rules)**:
   ...
   - **One-Line Rule**: For numbered lists (`1.`, `2.`) or bullets (`-`), never insert arbitrary line breaks (Enter). **Always print on a single line**, no matter how long the sentence is.
   - For ordered lists, explicitly write **physical sequential numbers** like `1.`, `2.`, `3.` to prevent numbering errors.
   - Do not insert unnecessary blank lines between list items.
...
- **Formatting Precautions:**
  ...
  2. **[IMPORTANT] List Spacing:** **Never insert empty lines** between the main category title and its sub-items, or between items. All items must be printed closely together.
  3. **[IMPORTANT] Numbering:** The numbers for all main category titles must increase sequentially in the order **1., 2., 3.**. Never start every item with **1.**.
...
- **Top Item (Title):** Write in the format `1. (2., 3. ... ) **Main Category Title**` (Bold) inside `:::accordion` with **sequential numbering**, and specify exact numbers in parentheses, like (Search Volume: 92,856 / Keyword Count: 6).
- **Sub-Items (Details):**
  ...
  - **Note:** Do not insert empty lines between items.
...
1. **Main Category Title 1 (Search Volume: 12,345)**
   - :k[Keyword1] (12,345),
   - :k[Keyword2] (5,678)...
   - Detail Item Content 1
   - Detail Item Content 2
2. **Main Category Title 2**
   - :k[Keyword1] (12,345)...
   - Detail Item Content...
:::
```
...
- **Top Item**: `1. (2., 3. ... ) **Main Category Title**` (Sequential numbering required) (Title representing path character)
- **Sub-Items**:
...
- Manual ensure readability using **Nested List** syntax.
- **Top Item**: `1. (2., 3. ... ) **Main Category Title**` (Sequential numbering required) (Search Volume: N / Connected Keyword Count: N)
- **Sub-Items**:
  - Do not insert empty lines between items.
...
1. **Main Category Title 1 (Search Volume: N / Connected Keyword Count: N)**
...
2. **Main Category Title 2 (Search Volume: N / Connected Keyword Count: N)**
   - **Keywords:** :k[Transition Point Keyword] (Search Volume: 000 / Connection: 00)
   - (Content...)
:::
```
...
1. **Key Keyword Based Title**: Describe specific insight content derived from user behavior patterns or data.
2. **Key Keyword Based Title**: Describe specific insight content derived from user behavior patterns or data.
3. **Key Keyword Based Title**: Describe specific insight content derived from user behavior patterns or data.
:::
```
