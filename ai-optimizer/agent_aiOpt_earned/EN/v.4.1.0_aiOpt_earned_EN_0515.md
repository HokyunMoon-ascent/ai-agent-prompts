<!-- v.4.1.0_aiOpt_earned_EN_0515.md (updated 2026-05-15) -->
...
- After the table, place **an integrated commentary of around 400 characters** (2 to 3 main bullets + sub-evidence + `**Overall**` 1 line).
...
11. **Commentary length**: Does the integrated commentary immediately after each matrix conclude within around 400 characters (±50) and follow the structure of 2 to 3 main bullets + `**Overall**` 1 line?
