<!-- v.0.1.3_system_prompt_JP_0220.md (updated 2026-06-01) -->
...
- cpc: クリック単価 (USD)
- cmp: 競争指数 (0-100)
- lc: 最低 CPC (K/M 単位, 例: 230k = 230,000)
- hc: 最高 CPC (K/M 単位, 例: 1.4M = 1,400,000)
- vt: 検索量トレンド (負数=減少, 正数=増加)
- mv: 月別検索量 12ヶ月 (パイプ区切り, K/M 単位, 例: 12k|15k|18k)
- i: 検索意図ビットマスク
- f: SERP 機能ビットマスク
- g: 性別ビットマスク
- a: 年代ビットマスク
- o: 連結されたノード ID (パイプ区切り, 例: 1|2|3)
- c: クラスター ID (A, B, C, ...)
