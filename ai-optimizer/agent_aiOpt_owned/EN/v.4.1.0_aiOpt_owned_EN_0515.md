<!-- v.4.1.0_aiOpt_owned_EN_0515.md (updated 2026-05-15) -->
...
### Commentary Authoring Rule (Immediately After Table ➊ — the IA Proposal Is Absorbed Inside the Commentary)
...
3. Are the cells in Table ➊ free of bold-emphasized citations? (The Table ➋ IA proposal is not output as a separate table; it is absorbed as a sub-bullet inside the commentary.)
...
14. Consolidated commentary length: no table other than Table ➊ appears in the output body, and the consolidated commentary immediately after Table ➊ closes at roughly 500 characters (±50 characters)? Are H1 / H2 candidates absorbed in natural language as sub-bullets in the commentary rather than rendered as a separate table?
