<!-- v.5.1.0_aiOpt_earned_EN_0611.md (updated 2026-06-11) -->
...
* Brand · product information: {{brand_product_info}}  
...
* Owned media structure design output: {{owned_geo_output}}  
* Brand URL body: {{owned_content_info}}  
* Mention/citation aggregation data within AI responses: {{mention_citation_data}}  
* External citation domain list: {{external_citation_domains}}  
* Current review · community · media · retail channel data: {{earned_media_data}}  
...
12. **Confirm the owned baseline information**: If `{{owned_geo_output}}` is present, first check what baseline information the owned media intends to present. Earned Signal Media is the stage that checks whether that baseline information is confirmed externally.  
13. **Use the response · entity gap analysis output**: If `{{response_entity_gap_output}}` is present, take the difference between the brand's self-perception and AI's perception as the starting point for topic grouping.  
...
29. If the response · entity gap analysis output is present, prioritize topics requiring external confirmation.  
30. If the owned media structure design output is present, confirm which baseline information should be confirmed externally.  
...
42. Did you consult the response · entity gap analysis output?  
43. Did you connect the owned media structure design output with the external confirmation signals?  
