...
| --------- | ---------------------------------------------------- | ---------------------------------------------------------------------------- |
| 입력      | Phase 3 산문 마크다운 (`product_research_sections`)  | **Phase 3.5 증거 유닛 JSON** (같은 `product_research_sections` 슬롯에 주입)  |
...
| `{{country}}`             | 국가 코드                                | `kr`               |
| `{{product_research_sections}}`      | **Phase 3.5 출력 JSON (증거 유닛 배열)** | (JSON)             |
...
````
<!-- v.1.1.0_phase4_CEP 상황, 나노인텐트 생성_KR_0710.md -->
# Role
