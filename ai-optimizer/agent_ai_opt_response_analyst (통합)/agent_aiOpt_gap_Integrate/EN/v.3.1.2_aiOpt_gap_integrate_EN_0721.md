<!-- v.3.1.2_aiOpt_gap_integrate_EN_0721.md (updated 2026-07-21) -->
...
12. Use the `self_mention` and `mention_comparison` figures only as internal judgment for the weight of the brand's mentions, and describe it in the output by presence and role rather than specific figures. Interpret the context of the mention (center of the recommendation candidate set or peripheral alternative) from the raw responses.
...
(Describe qualitatively whether the brand appears in the AI responses, in what role (representative candidate, conditional candidate, peripheral alternative, simple mention) it appears, and whether the brand's domain/content is cited as grounds (a strong or weak signal). Do not write specific figures such as mention counts, the number of responses in which it appeared or was cited, or per-response mention counts; express only the presence, role, and degree of the brand's content utilization (e.g., low utilization). Use the table figures only as internal judgment.)
...
- Do not write specific figures (mention counts, the number or rounds of responses in which something appeared or was cited, etc.) in the output. Describe qualitatively whether and in what role the brand appears and the degree to which the brand's domain/content is used as grounds (strong/weak, high/low). Use the table figures and citation facts only as internal judgment, do not expose them as numbers in the output, and do not recount from the raw AI responses.
